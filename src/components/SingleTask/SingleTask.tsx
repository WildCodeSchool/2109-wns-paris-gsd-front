    ...
    <>
      {
        (data && !loading && !error) && (
          <>
            ...
            <SingleTaskAssignee taskCreator={data.getTaskById.taskCreator} project={data.getTaskById.project} taskId={taskId}/>
            ...
            <SingleStatus  status={data.getTaskById.status} advancement={data.getTaskById.advancement} estimated_time={data.getTaskById.estimated_time} taskId={taskId}/>
          </>
        )
      }
    </>
